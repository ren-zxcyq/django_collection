...
class BookInstance(models.Model):
	...
	@property
	def is_overdue(self):
		if self.due_back and date.today() > self.due_back:	# CHECK if [due_back is empty] before making a comparison => This would ERROR
			return True
		return False
	...
	class Meta:
		...
		permissions = (('can_mark_returned', 'Set book as returned'),)	# Check PERMISSIONS
